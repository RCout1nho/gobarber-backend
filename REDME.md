...
- Utilizar Amazon SES para envios e-mail em produção;
...
- Para atualizar sua senha, o usuário deve informar as senha antiga;
...
- Cada agendamento deve durar 1 hora exatemente;
